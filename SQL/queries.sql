...
SELECT GAMES.WINNINGTEAM, COUNT(WINNINGTEAM) AS COUNTWIN, GAMES.GFIELD
FROM GAMES JOIN TEAMS 
ON GAMES.GFIELD = TEAMS.HOME
WHERE GAMES.GFIELD = TEAMS.HOME
GROUP BY GAMES.WINNINGTEAM
ORDER BY COUNTWIN DESC;
